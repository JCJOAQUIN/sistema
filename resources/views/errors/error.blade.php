...
<body>
	<div class="container">
		...
		<span class="title-error">= ERROR @yield('error')=</span><br>
		<span class="text-error">Una disculpa, la página no se encuentra.</span>
		<br><br><br>
		<span class="red-button">EN BREVE SERÁ REDIRECCIONADO A LA PÁGINA INICIAL</span>
	</div>
	<script>
		setTimeout(function()
		{
