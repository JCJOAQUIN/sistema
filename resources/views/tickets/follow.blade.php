		...
		@component('components.forms.searchForm', ["attributeEx" => "id=\"formsearch\"", "values" => $values, "hidden" => $hidden])
			@slot('contentEx')
				...
				<div class="col-span-2">
					...
					@component('components.inputs.input-text', ["attributeEx" => "type=\"text\" name=\"subject\" placeholder=\"Ingrese el asunto\" value=\"".(isset($subject) ? $subject : '')."\""]) @endcomponent
				</div>
				<div class="col-span-2">
		...
		@php
			...
			foreach($tickets as $ticket)
			{
				...
				[
					...
					[
						"content"	=>	["kind"	=>	"components.buttons.button", "variant"	=>	"success", "buttonElement" => "a", "attributeEx" => "title=\"Ver Ticket\" href=\"".route('tickets.show.follow',$ticket->idTickets)."\"", "label" => "<span class='icon-pencil'></span>"]
					],
				];
				$modelBody[]	=	$body;
			}
