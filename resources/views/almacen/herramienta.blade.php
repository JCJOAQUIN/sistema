...
@component('components.labels.title-divisor')    DETALLES DE HERRAMIENTA @endcomponent
...
<br><br>
@component('components.labels.title-divisor')    LISTA DE HERRAMIENTAS A REGISTRAR @endcomponent
