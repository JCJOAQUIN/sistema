...
@section('data')
	...
	@php
		...
		[
			...
			"Nombre de la Empresa de Origen"		=>	$request->movementsEnterprise->first()->idEnterpriseOriginR!="" ? App\Enterprise::find($request->movementsEnterprise->first()->idEnterpriseOriginR)->name : "---",
			"Clasificación del Gasto de Origen"		=>	$requestAccountOrigin!="" ? $requestAccountOrigin->account." - ".$requestAccountOrigin->description." (".$requestAccountOrigin->content.")" : "---",
			...
			"Clasificación del Gasto de Destino"	=>	$requestAccount!="" ? $requestAccount->account." - ".$requestAccount->description." (".$requestAccount->content.")" : "---",
