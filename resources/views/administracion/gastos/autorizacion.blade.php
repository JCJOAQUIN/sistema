		...
		@if(count($requests) > 0)
			@slot('export')
				@component('components.buttons.button', ["variant" => "success"])
					@slot('attributeEx')
						type="submit"
						formaction="{{ route('expenses.export.authorization') }}"
					@endslot
					@slot('classEx')
						export
					@endslot
				...
				[
					...
					[
						...
						[
							...
							"buttonElement" => "a",
							"attributeEx"   => "alt=\"Editar Solicitud\" title=\"Editar Solicitud\" href=\"".route('expenses.authorization.edit',$request->folio)."\""
						]
					]
				];
				$modelBody[] = $body;
