		...
		@if(count($requests) > 0)
			...
			<div class="text-right">
				<label>
					...
					@slot("attributeEx") type=submit formaction={{ route("computer.export.authorization") }} @endslot
					...
					[
						...
						[
							[
								...
								"buttonElement" => "a",
								"attributeEx" => "alt=\"Editar solicitud\" title=\"Editar solicitud\" href=\"".route("computer.authorization.edit",$request->folio)."\"",
								"variant" => "success",
