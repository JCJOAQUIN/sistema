				...
				<div class="text-right">
					<label>
						@component("components.buttons.button",["variant" => "success"])
							@slot("attributeEx") type=submit formaction={{ route("computer.export.review") }} @endslot
					...
					[
						...
						[
							[
								...
								"buttonElement" => "a",
								"attributeEx" => "alt=\"Editar solicitud\" title=\"Editar solicitud\" href=\"".route("computer.review.edit",$request->folio)."\"",
								"variant" => "success",
