				...
				<div class="flex flex-row justify-end">
					@component('components.labels.label')
						@component("components.buttons.button",['variant' => 'success'])
							@slot("attributeEx")
								type="submit"
								formaction="{{ route("stationery.export.authorization") }}"
							@endslot
							@slot("label")
		...
		@php
			...
			foreach ($requests as $request) 
			{
				...
				[
					...
					"variant"       => "success",
					"attributeEx"   => "alt=\"Editar Solicitud\" title=\"Editar Solicitud\" href=\"".route("stationery.authorization.edit",$request->folio)."\""
					]
				];
			$modelBody[] = $body;
			}
