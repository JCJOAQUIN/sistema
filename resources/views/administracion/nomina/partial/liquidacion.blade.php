@php
	...
	$body = [ "classEx" => "tr-payroll",
		...
		[
			...
			[
				"kind"			=> "components.inputs.input-text",
				"attributeEx"	=> "type=\"text\" readonly=\"readonly\" placeholder=\"Ingrese la fecha\" data-validation=\"required\" name=\"down_date[]\" value=\"".$valueEmployeeDownDate."\"",
		...
		[
			...
			[
				"kind"			=> "components.inputs.input-text",
				"attributeEx"	=> "type=\"text\" placeholder=\"Ingrese la percepción\" name=\"other_perception[]\"",
		...
		[
			...
			[
				"kind"			=> "components.inputs.input-text",
				"attributeEx"	=> "type=\"text\" placeholder=\"Ingrese la retención\" name=\"other_retention[]\"",
