...
@php
	...
	{
		$COAdditionalCharges = App\COAdditionalCharges::where('idUpload',$budget_id)->get();
		$table_body =
		"
	...
	$campos = [
		...
		'COAdditionalCharges' => [
			'title' => 'DETERMINACION DE CARGOS ADICIONALES ',
			'names' =>	$names,
		],
	];
@endphp

{!! Form::open(['route' => ['Sobrecosto.save.cargosAdicionales',$budget_id], 'method' => 'POST', 'id' => 'container-alta','files'=>true]) !!}
