...
class CreateCOCentralStaffTemplatesTable extends Migration
{
	/**
	 * Run the migrations.
	 *
	...
	public function up()
	{
		Schema::create('c_o_central_staff_templates', function (Blueprint $table)
		{
			$table->increments('id');
	...
	{
		Schema::dropIfExists('c_o_central_staff_templates');
	}
}
