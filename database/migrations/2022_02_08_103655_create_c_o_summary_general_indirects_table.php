...
class CreateCOSummaryGeneralIndirectsTable extends Migration
{
	/**
	 * Run the migrations.
	 *
	...
	public function up()
	{
		Schema::create('c_o_summary_general_indirects', function (Blueprint $table)
		{
			$table->increments('id');
	...
	{
		Schema::dropIfExists('c_o_summary_general_indirects');
	}
}
