...
class RequisitionEmployee extends Model
{
	...
	protected $casts = 
	[
		'admissionDate'	=> 'datetime:Y-m-d',
		'imssDate'		=> 'datetime:Y-m-d',
		'downDate'		=> 'datetime:Y-m-d',
		'endingDate'	=> 'datetime:Y-m-d',
		'reentryDate'	=> 'datetime:Y-m-d',
	];


	public function bankData()
	{
		return $this->hasMany(RequisitionEmployeeAccount::class,'idEmployee','id');
	}
	...
	{
		return $this->hasMany(RequisitionEmployeeDocument::class);
	}
}
